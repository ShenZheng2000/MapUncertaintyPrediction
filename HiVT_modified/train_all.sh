...
# Skeptic stage 3 — base trajectory model
# python train.py --root ../trj_data/skeptic --method base --embed_dim 128 --default_root_dir logs/base_skeptic

# Skeptic stage 3 — uncertainty trajectory model
# CUDA_VISIBLE_DEVICES=1 python train.py --root ../trj_data/skeptic --method unc --embed_dim 128 --default_root_dir logs/unc_skeptic
